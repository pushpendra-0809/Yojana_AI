  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-[#F5E7C6] p-8 text-black shadow-xl shadow-blue-500/20"
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-black-100 text-lg mb-6 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4">
             ...
             <div className="px-4 py-2 bg-green-500/20 backdrop-blur-md rounded-lg border border-emerald-400/20 text-sm font-semibold flex items-center gap-2">

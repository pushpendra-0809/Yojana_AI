...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-black/70 flex flex-col backdrop-blur-md">


      <div className="p-4 lg:p-8 flex items-center justify-between border-b border-slate-200 dark:border-slate-800 bg-[#F5E7C6]/70 backdrop-blur sticky top-0 z-10">
        <Link to="/login" className="flex items-center gap-2 text-black  font-medium transition-colors">
          <ArrowLeft className="w-5 h-5" />
          <span>Back to Login</span>
        </Link>
        <div className="flex items-center gap-3">
          {/* <ShieldCheck className="w-8 h-8 text-blue-600" /> */}
          <div className="bg-black/40 p-4 rounded-2xl backdrop-blur-md">
              <img 
  src="logo2.png" 
  alt="Custom Shield" 
  className="w-12 h-12" 
/>
          ...
          <h1 className="text-xl font-bold uppercase tracking-tight text-grey/70">{t('app_name')}</h1>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-12">
        ...
        >
          <Card className="p-0 overflow-hidden text-white">
            <div className="flex flex-col md:flex-row">
              {/* Steps Progress */}
              <div className="md:w-1/3 bg-[#222222] dark:bg-[#111111] border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 p-8">
                  ...
                  {[
                    ...
                    <div key={s.n} className="flex gap-4">
                      <div className={cn(
                        ...
                        step === s.n ? "bg-white text-black shadow-lg shadow-blue-500/30" : 
                        step > s.n ? "bg-emerald-500 text-brown" : "bg-slate-200 dark:bg-slate-800 text-slate-500"
                      )}>
                        {step > s.n ? '✓' : s.n}
                      </div>
